...
reactable(test2, 
  ...
  # Give rows a pointer cursor to indicate that they're clickable
    ...
    summary = colDef(show = TRUE, html = TRUE, style = cell_style(test2, font_size = "10px") )# overrides the default
  )
...
We advise to reserve **13 minutes** for the presentatin itself and use the additiona l time for the discussion. The discussion take place immediately after each presentation. 
...
test2 <- test %>% 
  ...
  select(c("round", "session", "author", "co-authors", "language", "title", "abstract"))
