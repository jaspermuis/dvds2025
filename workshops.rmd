...
Op 18 juni, de dag na de dag van de sociologie worden er twee workshops georganiseerd:  
- Workshop 1: **Populair wetenschappelijk schrijven** (Nederlands)  
- Workshop 2: **Open Science - replication website**  (English)

De workshops zijn van 10:00 tot 16:00 en zijn inclusief lunch. 

Meld je via deze [link](https://app.clubcollect.com/forms/nl/nsv/inschrijfformulier-workshopdag-2024) snel aan voor de workshops want er is slechts beperkt plaats. 
Het maximaal aantal deelnemers is 20 personen per workshop. De workshops gaan door bij minimaal 5 deelnemers. We laten uiterlijk 24 mei weten of de workshops doorgaan en of je bent geselecteerd (op basis van first come, first serve). 
