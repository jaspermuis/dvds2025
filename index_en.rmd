...
As of today, paper abstracts (max. 250 words) can be submitted. **Click [here](https://vuamsterdam.eu.qualtrics.com/jfe/form/SV_cMWvtRCv2yWhlOK) for a direct link to the submission form**. If possible, provide a concise description of the research questions, theoretical framework, methods and (preliminary) findings. When submitting, please indicate for which panel you want to apply. In addition to general panels, there are also various thematic panels, some of which are still open for abstracts. Papers that do not immediately fit within a theme can be submitted for the 'open panel'. On the registration form you can indicate whether you want to present in Dutch and/or English. The organization strives for a good distribution of Dutch and English sessions. Authors can present a maximum of 1 paper themselves, but can be co-authors on multiple papers in the program.

The deadline for abstract submission has been postponed to **Monday 31 March 2025**. After the closing date, the abstracts will be assessed and assigned to a panel by the organizing committee. If your paper does not fit into the desired panel, we will try to place you in another suitable panel.

You will be informed in mid-April 2024 whether your abstract has been accepted and to which panel you have been assigned. All participants (speakers, panel chairs, other interested parties) must then register via the NSV website to participate in the Sociology Day (this is possible from mid-April). Participation is not possible without registration and payment in advance.
